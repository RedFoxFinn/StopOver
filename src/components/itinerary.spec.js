...
describe('itinerary - unit tests', () => {
  ...
  it('default route', () => {
    ...
    setTimeout(() => {
      ...
      expect(component.textContent).toMatch('Lähtö:');
      ...
      expect(component.textContent).toMatch('Etapin');
      expect(component.textContent).toMatch('lähtö:');
      expect(component.textContent).toMatch('Etapin lähtö:');
      expect(component.textContent).toMatch('pituus:');
      expect(component.textContent).toMatch('Etapin pituus:');
      expect(component.textContent).toMatch('Eteneminen: ');
      expect(component.textContent).toMatch('kävellen');
      expect(component.textContent).toMatch('bussilla');
      expect(component.textContent).toMatch('Eteneminen: kävellen');
      expect(component.textContent).toMatch('Eteneminen: bussilla');
    }, 1500);
  });
});